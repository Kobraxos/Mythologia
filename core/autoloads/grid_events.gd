...
signal surface_removed(hex: Vector3i)

@warning_ignore("unused_signal")
## Émis lorsqu'une réaction chimique se produit sur un hexagone.
signal elemental_reaction_triggered(hex: Vector3i, reaction_id: StringName)
